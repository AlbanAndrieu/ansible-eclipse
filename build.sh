#!/bin/bash
# Ansible managed: /workspace/users/albandri10/env/ansible/roles/eclipse/templates/build.sh.j2 modified on 2014-09-25 11:57:12 by albandri on albandri-laptop-misys
